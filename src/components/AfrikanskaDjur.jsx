...
const images = importAll(require.context('../images/afrikanska', false, /\.(png|jpe?g|svg)$/));
  ...
  return (
    <>
      <div className='container'>
        ...
        <img onClick={() => rhino.play()} src={images['rhino.png']} alt="rhino"/>
        <img onClick={() => camel.play()} src={images['camel.png']} alt="camel"/>
        <img onClick={() => hippo.play()} src={images['hippo.png']} alt="hippo"/>
        <img onClick={() => tiger.play()} src={images['tiger.png']} alt="tiger"/>
        <img onClick={() => zebra.play()} src={images['zebra.png']} alt="zebra"/>
      </div>
    </>
  )
}
